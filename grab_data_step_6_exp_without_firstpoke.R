...
write.table(dat, '/Users/PC/Dropbox/eloras_rats/data/dat_step6expp.csv')
...
dat <- read.table('/Users/PC/Dropbox/eloras_rats/data/dat_step6expp.csv')
...
write.table(all_data, 'C:/Users/PC/Dropbox/eloras_rats/data/all_data_step6exp.csv')
...
df <- read.csv("/Users/PC/Dropbox/eloras_rats/data/all_data_step6exp.csv", header = FALSE, col.names = "data")
...
write.csv(df, file = "all_data_step6expcolumned.csv", row.names = FALSE)
...
all_data <- subset(read.csv('C:/Users/PC/Dropbox/eloras_rats/data/all_data_step6expcolumned.csv'))
...
write.csv(all_data, 'C:/Users/PC/Dropbox/eloras_rats/data/all_data_step6exp_filtered.csv', row.names = FALSE)
