...
write.table(dat, '/Users/PC/Dropbox/eloras_rats/data/dat_step7exp.csv')
...
dat <- read.table('/Users/PC/Dropbox/eloras_rats/data/dat_step7exp.csv')
...
all_data <- ddply(dat, .(rat_nr, session, trial_index, group_width, group_dir), function(z){ #int_offset
  ...
  return(c(cond, start_light, init_entry, int_offset, first_check, first_check_lat, sumNP1, sumNP2, sumNP3, sumNP4, sumNP5, lat_NP1, lat_NP2, lat_NP3,lat_NP4,lat_NP5))
}, .progress='text')

colnames(all_data)[c(6:21)] <- c('cond','start_light', 'init_entry', 'int_offset', 'first_check', 'first_check_lat', 'sumNP1','sumNP2','sumNP3','sumNP4','sumNP5','lat_NP1','lat_NP2','lat_NP3','lat_NP4','lat_NP5')
# wide group
...
write.table(all_data, 'C:/Users/PC/Dropbox/eloras_rats/data/second_half_step7exp.csv')
...
df <- read.csv("/Users/PC/Dropbox/eloras_rats/data/second_half_step7exp.csv", header = FALSE, col.names = "data")

# Split the single column into multiple columns
df <- separate(df, data, into = c("col1", "col2", "col3", "col4", "col5", "col6", "col7", "col8", "col9", "col10", "col11", "col12", "col13", "col14", "col15", "col16","col17","col18","col19","col20","col21","col22","col23"), sep = " ")
...
all_data <- subset(read.csv('C:/Users/PC/Dropbox/eloras_rats/data/second_half_step7expcolumned.csv'))
...
write.csv(all_data, 'C:/Users/PC/Dropbox/eloras_rats/data/second_half_step7expfiltered.csv', row.names = FALSE)
